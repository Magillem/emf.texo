...
/**
 * The <b>{@link ModelFactory}</b> for the types of this model: Bz420913. It contains code to create instances
...
public class Bz420913ModelFactory implements ModelFactory {
   ...
   * 
   * @return an instance of the model object representing the EClass Bz420913_O
   * @generated
   */
   ...
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return an instance of the model object representing the EClass Bz420913_T
   * @generated
   */
  ...
  public static class Bz420913_OModelObject<E extends Bz420913_O> extends
    ...
    public Object eGet(EStructuralFeature eStructuralFeature) {
      ...
      switch (featureID) {
      case Bz420913ModelPackage.BZ420913_O_DB_ID_FEATURE_ID:
        return getTarget().getDb_Id();
      case Bz420913ModelPackage.BZ420913_O_DB_VERSION_FEATURE_ID:
      ...
      case Bz420913ModelPackage.BZ420913_O_MULTIMULTIBIDIRECTIONAL_FEATURE_ID:
        return getTarget().getMultiMultiBidirectional();
      default:
    ...
    public void eSet(EStructuralFeature eStructuralFeature, Object value) {
      ...
      case Bz420913ModelPackage.BZ420913_O_MULTIBIDIRECTIONAL_FEATURE_ID:
        ...
        return;
      case Bz420913ModelPackage.BZ420913_O_MULTIMULTIBIDIRECTIONAL_FEATURE_ID:
        getTarget().setMultiMultiBidirectional((List<Bz420913_T>) value);
        return;
      default:
    ...
    public boolean eAddTo(EStructuralFeature eStructuralFeature, Object value) {
      ...
      case Bz420913ModelPackage.BZ420913_O_MULTIMULTIBIDIRECTIONAL_FEATURE_ID:
        return getTarget().addToMultiMultiBidirectional((Bz420913_T) value);
      default:
    ...
    public boolean eRemoveFrom(EStructuralFeature eStructuralFeature, Object value) {
      ...
      case Bz420913ModelPackage.BZ420913_O_MULTIBIDIRECTIONAL_FEATURE_ID:
        return getTarget().removeFromMultiBidirectional((Bz420913_T) value);

      case Bz420913ModelPackage.BZ420913_O_MULTIMULTIBIDIRECTIONAL_FEATURE_ID:
        return getTarget().removeFromMultiMultiBidirectional((Bz420913_T) value);
      default:
  ...
  public static class Bz420913_TModelObject<E extends Bz420913_T> extends
    ...
    public Object eGet(EStructuralFeature eStructuralFeature) {
      final int featureID = eClass().getFeatureID(eStructuralFeature);
      switch (featureID) {
      case Bz420913ModelPackage.BZ420913_T_DB_ID_FEATURE_ID:
        return getTarget().getDb_Id();
      case Bz420913ModelPackage.BZ420913_T_DB_VERSION_FEATURE_ID:
        return getTarget().getDb_version();
      ...
      case Bz420913ModelPackage.BZ420913_T_MULTIBIDIRECTIONAL_FEATURE_ID:
        return getTarget().getMultiBidirectional();
      case Bz420913ModelPackage.BZ420913_T_MULTIMULTIBIDIRECTIONAL_FEATURE_ID:
        return getTarget().getMultiMultiBidirectional();
      default:
        return super.eGet(eStructuralFeature);
      }
    ...
    public void eSet(EStructuralFeature eStructuralFeature, Object value) {
      ...
      case Bz420913ModelPackage.BZ420913_T_MULTIBIDIRECTIONAL_FEATURE_ID:
        ...
        return;
      case Bz420913ModelPackage.BZ420913_T_MULTIMULTIBIDIRECTIONAL_FEATURE_ID:
        getTarget().setMultiMultiBidirectional((List<Bz420913_O>) value);
        return;
      default:
        super.eSet(eStructuralFeature, value);
      }
    ...
    public boolean eAddTo(EStructuralFeature eStructuralFeature, Object value) {
      ...
      case Bz420913ModelPackage.BZ420913_T_MULTIMULTIBIDIRECTIONAL_FEATURE_ID:
        return getTarget().addToMultiMultiBidirectional((Bz420913_O) value);
      default:
        return super.eAddTo(eStructuralFeature, value);
      }
    }
    ...
    public boolean eRemoveFrom(EStructuralFeature eStructuralFeature, Object value) {
      ...
      case Bz420913ModelPackage.BZ420913_T_MULTIMULTIBIDIRECTIONAL_FEATURE_ID:
        return getTarget().removeFromMultiMultiBidirectional((Bz420913_O) value);
      default:
        return super.eRemoveFrom(eStructuralFeature, value);
      }
    }
