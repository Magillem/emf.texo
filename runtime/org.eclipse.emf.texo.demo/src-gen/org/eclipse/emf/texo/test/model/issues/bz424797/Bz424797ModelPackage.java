...
/**
 * The <b>Package</b> for the model '<em><b>Bz424797</b></em>'. It contains
...
public class Bz424797ModelPackage extends ModelPackage {
	...
	public static Bz424797ModelPackage initialize() {
		...
		if (isInitialized) {
			return (Bz424797ModelPackage) ModelResolver.getInstance()
		...
		ModelResolver.getInstance().registerClassModelMapping(
				AbstractSuper424797.class,
				modelPackage.getAbstractSuper424797EClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(Sub4242797.class,
				modelPackage.getSub4242797EClass(), modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(
				Other4242797.class, modelPackage.getOther4242797EClass(),
				modelPackage);

		DaoRegistry.getInstance().registerDao(AbstractSuper424797.class,
				AbstractSuper424797Dao.class);
		DaoRegistry.getInstance().registerDao(Sub4242797.class,
				Sub4242797Dao.class);
		DaoRegistry.getInstance().registerDao(Other4242797.class,
				Other4242797Dao.class);
	...
	/**
	 * Returns the {@link EClass} '<em><b>AbstractSuper424797</b></em>'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return an instance of the {@link EClass} '
	 *         <em><b>AbstractSuper424797</b></em>'
	 * @generated
	 */
	public EClass getAbstractSuper424797EClass() {
		return (EClass) getEPackage().getEClassifiers().get(
				ABSTRACTSUPER424797_CLASSIFIER_ID);
	}

	/**
	 * Returns the {@link EClass} '<em><b>Sub4242797</b></em>'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	public EClass getSub4242797EClass() {
		return (EClass) getEPackage().getEClassifiers().get(
				SUB4242797_CLASSIFIER_ID);
	}

	/**
	 * Returns the {@link EClass} '<em><b>Other4242797</b></em>'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
