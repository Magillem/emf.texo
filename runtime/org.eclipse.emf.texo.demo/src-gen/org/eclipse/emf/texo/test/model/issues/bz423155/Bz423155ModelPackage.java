...
/**
 * The <b>Package</b> for the model '<em><b>Bz423155</b></em>'. It contains
...
public class Bz423155ModelPackage extends ModelPackage {
	 ...
	 * @generated
	 */
	public static final int MAIN423155_EMBEDDED1_FEATURE_ID = 0;
	 ...
	 * @generated
	 */
	public static final int MAIN423155_EMBEDDED2_FEATURE_ID = 1;
	 ...
	 * @generated
	 */
	public static final int MAIN423155_EMBEDDED3_FEATURE_ID = 2;
	...
	public static Bz423155ModelPackage initialize() {
		...
		if (isInitialized) {
			return (Bz423155ModelPackage) ModelResolver.getInstance()
		...
		ModelResolver.getInstance().registerClassModelMapping(
				Embedded423155.class, modelPackage.getEmbedded423155EClass(),
				modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(Main423155.class,
				modelPackage.getMain423155EClass(), modelPackage);

		DaoRegistry.getInstance().registerDao(Embedded423155.class,
				Embedded423155Dao.class);
		DaoRegistry.getInstance().registerDao(Main423155.class,
				Main423155Dao.class);
	...
	/**
	 * Returns the {@link EClass} '<em><b>Embedded423155</b></em>'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	public EClass getEmbedded423155EClass() {
		return (EClass) getEPackage().getEClassifiers().get(
				EMBEDDED423155_CLASSIFIER_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '
	 * <em><b>Embedded423155.name1</b></em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @return an instance of the {@link EStructuralFeature}: '
	 *         <em><b>Embedded423155.name1</b></em>'.
	 * @generated
	 */
	public EAttribute getEmbedded423155_Name1() {
		return (EAttribute) getEmbedded423155EClass()
				.getEAllStructuralFeatures().get(
						EMBEDDED423155_NAME1_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '
	 * <em><b>Embedded423155.name2</b></em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @return an instance of the {@link EStructuralFeature}: '
	 *         <em><b>Embedded423155.name2</b></em>'.
	 * @generated
	 */
	public EAttribute getEmbedded423155_Name2() {
		return (EAttribute) getEmbedded423155EClass()
				.getEAllStructuralFeatures().get(
						EMBEDDED423155_NAME2_FEATURE_ID);
	}

	/**
	 * Returns the {@link EClass} '<em><b>Main423155</b></em>'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	public EClass getMain423155EClass() {
		return (EClass) getEPackage().getEClassifiers().get(
				MAIN423155_CLASSIFIER_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '
	 * <em><b>Main423155.embedded1</b></em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @return an instance of the {@link EStructuralFeature}: '
	 *         <em><b>Main423155.embedded1</b></em>'.
	 * @generated
	 */
	public EReference getMain423155_Embedded1() {
		return (EReference) getMain423155EClass().getEAllStructuralFeatures()
				.get(MAIN423155_EMBEDDED1_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '
	 * <em><b>Main423155.embedded2</b></em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @return an instance of the {@link EStructuralFeature}: '
	 *         <em><b>Main423155.embedded2</b></em>'.
	 * @generated
	 */
	public EReference getMain423155_Embedded2() {
		return (EReference) getMain423155EClass().getEAllStructuralFeatures()
				.get(MAIN423155_EMBEDDED2_FEATURE_ID);
	}

	/**
	 * Returns the {@link EStructuralFeature} '
	 * <em><b>Main423155.embedded3</b></em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @return an instance of the {@link EStructuralFeature}: '
	 *         <em><b>Main423155.embedded3</b></em>'.
	 * @generated
	 */
	public EReference getMain423155_Embedded3() {
		return (EReference) getMain423155EClass().getEAllStructuralFeatures()
				.get(MAIN423155_EMBEDDED3_FEATURE_ID);
	}
