...
/**
 * The <b>{@link ModelFactory}</b> for the types of this model: bz444321. It
	...
	public static class MainElementModelObject<E extends MainElement> extends
		...
		public void eSet(EStructuralFeature eStructuralFeature, Object value) {
			...
			case Bz444321ModelPackage.MAINELEMENT_MULTICONTAINMENT_FEATURE_ID:
				...
				return;
			case Bz444321ModelPackage.MAINELEMENT_MULTICONTAINMENTNOORPHANREMOVAL_FEATURE_ID:
				getTarget().setMultiContainmentNoOrphanRemoval(
						(List<SubElement>) value);
				return;
			default:
		...
		public boolean eAddTo(EStructuralFeature eStructuralFeature,
			...
			case Bz444321ModelPackage.MAINELEMENT_MULTINOORPHANREMOVAL_FEATURE_ID:
				return getTarget().getMultiNoOrphanRemoval().add(
						(SubElement) value);

			case Bz444321ModelPackage.MAINELEMENT_MULTICONTAINMENT_FEATURE_ID:
				return getTarget().getMultiContainment()
						.add((SubElement) value);

			case Bz444321ModelPackage.MAINELEMENT_MULTICONTAINMENTNOORPHANREMOVAL_FEATURE_ID:
				return getTarget().getMultiContainmentNoOrphanRemoval().add(
						(SubElement) value);
			default:
		...
		public boolean eRemoveFrom(EStructuralFeature eStructuralFeature,
			...
			case Bz444321ModelPackage.MAINELEMENT_MULTICONTAINMENTNOORPHANREMOVAL_FEATURE_ID:
				return getTarget().getMultiContainmentNoOrphanRemoval().remove(
						value);
			default:
